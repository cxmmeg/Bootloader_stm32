...
#define set_bits_val(val, set, start, end) (val = hole(val, start, end) | fill(set, start, end))
//---------------------------------------------------------------------------------------
...
//---------------------------------------------------------------------------------------
uint16_t AscToHex(uint8_t aHex);

uint32_t get_be_val_half(const uint8_t * p, int bytes);
